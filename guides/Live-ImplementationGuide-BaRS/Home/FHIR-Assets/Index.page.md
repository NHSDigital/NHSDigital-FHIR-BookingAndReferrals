...
- **UK Core**
specifies a set of constraints and/or extensions to specific base HL7 FHIR resources to enable consistent information flows across UK borders, to improve health and care outcomes for all citizens
