...
The follow is a list of headers needed for the requests, these follow the patern needed by BARS as follows {{pagelink:core-EndToEndWorkflow-HTTPHeader-1.2.1, text:Headers}}
