...
Making a Validation Request for this application follows the {{pagelink:core-standardpattern-1.6.0, text:standard pattern for BaRS Composite Messages}}.
...
To cancel a Validation Request this Application follows the {{pagelink:core-SPCancellation-1.6.0, text:standard pattern for BaRS cancellation}}. 
