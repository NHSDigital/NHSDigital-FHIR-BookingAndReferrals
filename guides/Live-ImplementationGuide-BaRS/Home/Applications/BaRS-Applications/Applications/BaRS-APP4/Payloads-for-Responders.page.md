...
### MessageHeader Resource
For detailed information on the use of MessageHeader please refer to the {{pagelink:core-SPMessageHeader-1.3.1, text:Standard Pattern - Message Header}} for more information. 
