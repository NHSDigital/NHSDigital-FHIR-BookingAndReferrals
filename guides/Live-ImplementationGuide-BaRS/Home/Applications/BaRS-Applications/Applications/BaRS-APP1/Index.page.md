...
| AST (999 Ambulance Service Trust) to ED (Emergency Department)                                 | AST to ED | A1T5 |
| AST (999 Ambulance Service Trust) to  UTC (Urgent Treatment Centre)                            | AST to UTC | A1T6 |
...
| AST (999 Ambulance Service Trust) to SDEC (Same Day Emergency Care)                            | AST to SDEC | A1T9 |
