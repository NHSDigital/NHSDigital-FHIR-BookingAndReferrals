...
| {{pagelink:application8, text: Referrals into a broker for Healthcare Service selection (Application 8)}} | <p>Advice and guidance referring into electronic Referral Service (eRS)<br>111 Online referring into electronic Referral Service<br>nhs.uk referring into electronic Referral Service | 1.0.0-alpha.2   | <a href="https://digital.nhs.uk/developer/api-catalogue/booking-and-referral-fhir/v1.3.0" target="_blank">API Spec v1.3.0 and above</a>  | {{pagelink:design-core-1.1.4, text:Core v1.3.0 and above}} |
