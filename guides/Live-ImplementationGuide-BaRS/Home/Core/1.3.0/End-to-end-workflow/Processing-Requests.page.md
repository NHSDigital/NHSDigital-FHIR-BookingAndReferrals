---
topic: core-EndToEndWorkflow-Processing-1.3.0
---
...
Please see the {{pagelink:Core-StandardPattern-1.3.0, text: Standard Patterns}} for generic guidance for processing messages.
