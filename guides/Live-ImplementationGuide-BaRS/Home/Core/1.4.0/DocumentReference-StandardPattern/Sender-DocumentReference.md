---
topic: core-StandardPattern-document-reference-Sender-1.4.0
---
...
The booking or referral resource can be retrieved by making a GET request for the [booking](https://digital.nhs.uk/developer/api-catalogue/booking-and-referral-fhir/v1.4.0#get-/Appointment/-id-) or [referral](https://digital.nhs.uk/developer/api-catalogue/booking-and-referral-fhir/v1.4.0#get-/ServiceRequest/-id-). 
