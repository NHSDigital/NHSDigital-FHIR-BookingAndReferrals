...
The rationale, described in the {{pagelink:core-failure_scenarios-1.4.0, text:error handling}} section is that as much information on the nature of the failure as possible is provided in a standard way.
