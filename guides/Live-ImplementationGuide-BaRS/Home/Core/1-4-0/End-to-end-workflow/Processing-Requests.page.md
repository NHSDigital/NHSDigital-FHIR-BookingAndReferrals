---
topic: core-EndToEndWorkflow-Processing-1.4.0
---
...
Please see the {{pagelink:Core-StandardPattern-1.4.0, text: Standard Patterns}} for generic guidance for processing messages.
